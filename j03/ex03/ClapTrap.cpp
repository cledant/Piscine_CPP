...
/*   Updated: 2017/04/06 19:54:08 by cledant          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "CL4P-TP <" << this->_name << "> basicly throws a grenade <" << target << "> causing <" << this->_ranged_damage << "> point of ranged damage" << std::endl;
}

void			ClapTrap::meleeAttack(std::string const & target) const
{
	std::cout << "CL4P-TP <" << this->_name << "> basicly attacks <" << target << "> causing <" << this->_melee_damage << "> point of mele damage" << std::endl;
}
